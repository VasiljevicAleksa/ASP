...
public class Queen extends Piece {
    ...
    private final static int[] CANDIDATE_MOVE_VECTOR_COORDINATES = {-9, -8, -7, -1, 1, 7, 8, 9}; //unija za konja i lovca
    ...
    private static boolean isEighthColumnExclusion(final int currentPosition, final int candidateOffset) {
        ...
        if (BoardUtils.EIGHTH_COLUMN[currentPosition] && (candidateOffset == -7 || candidateOffset == 1 || candidateOffset == 9)) {
            return true;
        }
        else {
            return false;
